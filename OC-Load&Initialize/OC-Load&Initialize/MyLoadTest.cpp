...
static __NSConstantStringImpl __NSConstantStringImpl_MyLoadTest_m_0 __attribute__ ((section ("__DATA, __cfstring"))) = {__CFConstantStringClassReference,0x000007c8,"%@",2};
//
//  MyLoadTest.m
...
#include "MyLoadTest.h"

// @implementation MyLoadTest


static void _C_MyLoadTest_load(Class self, SEL _cmd) {
    NSLog((NSString *)&__NSConstantStringImpl_MyLoadTest_m_0, NSStringFromClass(self));
}
...
} _OBJC_CLASS_METHODS_MyLoadTest __attribute__ ((used, section ("__OBJC, __cls_meth")))= {
	0, 1
	,{{(SEL)"load", "v16@0:8", (void *)_C_MyLoadTest_load}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_MyLoadTest __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"NSObject", "NSObject", "MyLoadTest", 0,2, sizeof(struct _objc_class), 0
	, (struct _objc_method_list *)&_OBJC_CLASS_METHODS_MyLoadTest
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_MyLoadTest __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_MyLoadTest, "NSObject", "MyLoadTest", 0,1,sizeof(struct MyLoadTest),0,0,0,0,0,0
};
