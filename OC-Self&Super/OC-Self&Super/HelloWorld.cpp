...
static void _I_HelloWorld_helloWorld(struct HelloWorld * self, SEL _cmd) {
    
    ((Class (*)(id, SEL))(void *)objc_msgSend)((id)self, sel_registerName("class"));
    ((Class (*)(id, SEL))(void *)objc_msgSend)(objc_getClass("HelloWorld"), sel_registerName("class"));
    ((Class (*)(struct objc_super *, SEL))(void *)objc_msgSendSuper)((struct objc_super){(id)self, (id)class_getSuperclass((Class)objc_getClass("HelloWorld"))}, sel_registerName("class"));
...
} _OBJC_INSTANCE_METHODS_HelloWorld __attribute__ ((used, section ("__OBJC, __inst_meth")))= {
	0, 1
	,{{(SEL)"helloWorld", "v16@0:8", (void *)_I_HelloWorld_helloWorld}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_HelloWorld __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"NSObject", "NSObject", "HelloWorld", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_HelloWorld __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_HelloWorld, "NSObject", "HelloWorld", 0,1,sizeof(struct HelloWorld),0, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_HelloWorld, 0
	,0,0,0
};
